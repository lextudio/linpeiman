...
htmlhelp_basename = 'linpeimanarchive'
...
latex_documents = [
  (master_doc, 'linpeimanarchive.tex', u'Peiman Lin Archive',
   u'Peiman Lin', 'manual'),
]
...
man_pages = [
    (master_doc, 'linpeimanarchive', u'Peiman Lin Archive',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'linpeimanarchive', u'Peiman Lin Archive',
   author, 'linpeimanarchive', 'Peiman Lin Archive',
...
if not on_rtd:
    edit_on_github_project = 'lextudio/linpeiman'
...
def setup(app):
    ...
    if not on_rtd:
        ...
        """
        app.add_javascript("https://www.googletagmanager.com/gtag/js?id=UA-1962620-13")
